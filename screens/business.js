    ...
    <SafeAreaView style={{ backgroundColor: accentColor1 }}>
      ...
      >
        <KeyboardAvoidingView
          ...
          <View style={{ borderBottomColor: "gray", borderBottomWidth: 0.2, padding: 20 }}>
            <Text style={{ fontSize: 20, color: textColor }}>Comments</Text>
          </View>
          <ScrollView style={{ marginVertical: 10 }}>
            {Array(20).fill(null).map((_, i) => (
              <View style={{ borderBottomColor: "gray", borderBottomWidth: 0.2, padding: 10 }}>
                <View key={i} style={{ flexDirection: "row", gap: 10 }}>
                  ...
                  <Text style={{ marginLeft: "auto", fontSize: 15, color: textColor }}>5 months ago</Text>
                </View>
              </View>
            ))}
          ...
          <View style={styles.textinput}>
            <TextInput
              style={{ flexGrow: 1, maxWidth: "90%", color: textColor,paddingBottom:5 }}
              multiline
